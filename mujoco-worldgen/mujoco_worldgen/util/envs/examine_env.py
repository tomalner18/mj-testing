...
from mujoco_worldgen.util.envs.rollout_viewer import RolloutViewer


def examine_env(env_name, env_kwargs, size, core_dir, envs_dir, xmls_dir='xmls',
                env_viewer=RolloutViewer, seed=None):
    '''
